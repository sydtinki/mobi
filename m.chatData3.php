...
if($rows>=60){ echo "<span id='LoadAll'>[ <a href='javascript:loadMore3()'>Load Earlier Messages </a>]</span><p><b id='loading'>loading..</b><p>"; for($i=0; $i<$rows; $i++){ $idx++; 
